...
HD_PWD='C:/Users/Public/Vivado/MiddleServo/MiddleServo.runs/MiddleServo_MiddleServo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MiddleServo_MiddleServo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MiddleServo_MiddleServo_0_0.tcl
