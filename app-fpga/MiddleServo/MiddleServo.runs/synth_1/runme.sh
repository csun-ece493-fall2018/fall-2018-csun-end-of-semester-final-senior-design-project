...
HD_PWD='C:/Users/Public/Vivado/MiddleServo/MiddleServo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MiddleServo_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MiddleServo_wrapper.tcl
