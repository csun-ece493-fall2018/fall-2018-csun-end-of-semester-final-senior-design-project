...
HD_PWD='C:/Users/Public/Vivado/MiddleServo/MiddleServo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MiddleServo_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MiddleServo_wrapper.tcl -notrace
