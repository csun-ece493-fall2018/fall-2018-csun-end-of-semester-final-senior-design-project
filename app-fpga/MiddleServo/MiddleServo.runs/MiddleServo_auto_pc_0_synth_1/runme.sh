...
HD_PWD='C:/Users/Public/Vivado/MiddleServo/MiddleServo.runs/MiddleServo_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MiddleServo_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MiddleServo_auto_pc_0.tcl
