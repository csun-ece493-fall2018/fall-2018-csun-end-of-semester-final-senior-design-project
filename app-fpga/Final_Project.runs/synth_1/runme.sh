...
HD_PWD='C:/Users/Public/Vivado/Final_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sensor_Project_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sensor_Project_wrapper.tcl
