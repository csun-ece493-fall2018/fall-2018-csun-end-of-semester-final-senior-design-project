...
HD_PWD='C:/Users/Public/Vivado/Final_Project.runs/Sensor_Project_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sensor_Project_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sensor_Project_xbar_0.tcl
