...
HD_PWD='C:/Users/Public/Vivado/Final_Project.runs/Sensor_Project_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sensor_Project_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sensor_Project_processing_system7_0_1.tcl
