...
HD_PWD='C:/Users/Public/Vivado/Final_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sensor_Project_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sensor_Project_wrapper.tcl -notrace
