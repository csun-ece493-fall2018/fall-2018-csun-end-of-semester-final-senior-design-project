...
HD_PWD='C:/Users/Public/Vivado/SideServos/SideServos.runs/SideServos_SideServos_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SideServos_SideServos_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SideServos_SideServos_0_0.tcl
