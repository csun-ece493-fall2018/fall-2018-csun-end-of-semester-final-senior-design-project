...
HD_PWD='C:/Users/Public/Vivado/SideServos/SideServos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SideServos_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SideServos_wrapper.tcl
