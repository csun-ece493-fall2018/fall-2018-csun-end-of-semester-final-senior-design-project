...
HD_PWD='C:/Users/Public/Vivado/SideServos/SideServos.runs/SideServos_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SideServos_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SideServos_processing_system7_0_1.tcl
