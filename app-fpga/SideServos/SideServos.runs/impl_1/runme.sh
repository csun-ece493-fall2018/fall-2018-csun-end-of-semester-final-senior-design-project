...
HD_PWD='C:/Users/Public/Vivado/SideServos/SideServos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SideServos_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SideServos_wrapper.tcl -notrace
