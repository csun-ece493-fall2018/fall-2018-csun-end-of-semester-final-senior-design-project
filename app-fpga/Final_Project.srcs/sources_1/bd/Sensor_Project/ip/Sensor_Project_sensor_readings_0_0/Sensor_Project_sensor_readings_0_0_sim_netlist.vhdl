...
-- Date        : Tue Nov 27 21:42:25 2018
-- Host        : Drew-GLT running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/Public/Vivado/Final_Project.srcs/sources_1/bd/Sensor_Project/ip/Sensor_Project_sensor_readings_0_0/Sensor_Project_sensor_readings_0_0_sim_netlist.vhdl
-- Design      : Sensor_Project_sensor_readings_0_0
...
entity Sensor_Project_sensor_readings_0_0_clkFreqDivider is
  port (
  ...
  attribute ORIG_REF_NAME of Sensor_Project_sensor_readings_0_0_clkFreqDivider : entity is "clkFreqDivider";
end Sensor_Project_sensor_readings_0_0_clkFreqDivider;

architecture STRUCTURE of Sensor_Project_sensor_readings_0_0_clkFreqDivider is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Sensor_Project_sensor_readings_0_0_edge_detection is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Sensor_Project_sensor_readings_0_0_edge_detection : entity is "edge_detection";
end Sensor_Project_sensor_readings_0_0_edge_detection;

architecture STRUCTURE of Sensor_Project_sensor_readings_0_0_edge_detection is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Sensor_Project_sensor_readings_0_0_edge_detection_1 is
  port (
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
    O : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \pwm_width_reg[7]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Sensor_Project_sensor_readings_0_0_edge_detection_1 : entity is "edge_detection";
end Sensor_Project_sensor_readings_0_0_edge_detection_1;

architecture STRUCTURE of Sensor_Project_sensor_readings_0_0_edge_detection_1 is
  signal data_ff : STD_LOGIC;
  signal din : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Sensor_Project_sensor_readings_0_0_ultrasonic_reading is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Sensor_Project_sensor_readings_0_0_ultrasonic_reading : entity is "ultrasonic_reading";
end Sensor_Project_sensor_readings_0_0_ultrasonic_reading;

architecture STRUCTURE of Sensor_Project_sensor_readings_0_0_ultrasonic_reading is
...
begin
PWM_neg: entity work.Sensor_Project_sensor_readings_0_0_edge_detection_1
     port map (
      E(0) => PWM_neg_n_0,
      O(3) => PWM_neg_n_1,
      O(2) => PWM_neg_n_2,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Sensor_Project_sensor_readings_0_0_ultrasonic_reading_0 is
  port (
    Q : out STD_LOGIC_VECTOR ( 7 downto 0 );
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_radar2_pwm : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Sensor_Project_sensor_readings_0_0_ultrasonic_reading_0 : entity is "ultrasonic_reading";
end Sensor_Project_sensor_readings_0_0_ultrasonic_reading_0;

architecture STRUCTURE of Sensor_Project_sensor_readings_0_0_ultrasonic_reading_0 is
  signal PWM_neg_n_0 : STD_LOGIC;
  signal PWM_neg_n_1 : STD_LOGIC;
  signal PWM_neg_n_2 : STD_LOGIC;
  signal PWM_neg_n_3 : STD_LOGIC;
...
begin
PWM_neg: entity work.Sensor_Project_sensor_readings_0_0_edge_detection
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Sensor_Project_sensor_readings_0_0_main_top is
  port (
    CLK : out STD_LOGIC;
    Q : out STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Sensor_Project_sensor_readings_0_0_main_top : entity is "main_top";
end Sensor_Project_sensor_readings_0_0_main_top;

architecture STRUCTURE of Sensor_Project_sensor_readings_0_0_main_top is
...
radar1: entity work.Sensor_Project_sensor_readings_0_0_ultrasonic_reading
     port map (
      Q(7 downto 0) => radar1_reading(7 downto 0),
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_radar1_pwm => s00_axi_radar1_pwm
    );
radar2: entity work.Sensor_Project_sensor_readings_0_0_ultrasonic_reading_0
     port map (
      Q(7 downto 0) => radar2_reading(7 downto 0),
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_radar2_pwm => s00_axi_radar2_pwm
    );
uut: entity work.Sensor_Project_sensor_readings_0_0_clkFreqDivider
     port map (
      AR(0) => AR(0),
      \DATA_2_reg[0][0]\ => \^clk\,
      s00_axi_aclk => s00_axi_aclk
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Sensor_Project_sensor_readings_0_0_sensor_readings_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Sensor_Project_sensor_readings_0_0_sensor_readings_v1_0_S00_AXI : entity is "sensor_readings_v1_0_S00_AXI";
end Sensor_Project_sensor_readings_0_0_sensor_readings_v1_0_S00_AXI;

architecture STRUCTURE of Sensor_Project_sensor_readings_0_0_sensor_readings_v1_0_S00_AXI is
...
uut: entity work.Sensor_Project_sensor_readings_0_0_main_top
     port map (
      AR(0) => rst,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Sensor_Project_sensor_readings_0_0_sensor_readings_v1_0 is
  port (
    s00_axi_wready : out STD_LOGIC;
    s00_axi_awready : out STD_LOGIC;
    s00_axi_arready : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Sensor_Project_sensor_readings_0_0_sensor_readings_v1_0 : entity is "sensor_readings_v1_0";
end Sensor_Project_sensor_readings_0_0_sensor_readings_v1_0;

architecture STRUCTURE of Sensor_Project_sensor_readings_0_0_sensor_readings_v1_0 is
begin
sensor_readings_v1_0_S00_AXI_inst: entity work.Sensor_Project_sensor_readings_0_0_sensor_readings_v1_0_S00_AXI
     port map (
      \DATA_2_reg[0][0]\ => CLK,
      clkSignal_reg => clkSignal_reg,
      s00_axi_aclk => s00_axi_aclk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Sensor_Project_sensor_readings_0_0 is
  port (
    s00_axi_radar1_pwm : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of Sensor_Project_sensor_readings_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Sensor_Project_sensor_readings_0_0 : entity is "Sensor_Project_sensor_readings_0_0,sensor_readings_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Sensor_Project_sensor_readings_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of Sensor_Project_sensor_readings_0_0 : entity is "sensor_readings_v1_0,Vivado 2018.2";
end Sensor_Project_sensor_readings_0_0;

architecture STRUCTURE of Sensor_Project_sensor_readings_0_0 is
...
U0: entity work.Sensor_Project_sensor_readings_0_0_sensor_readings_v1_0
     port map (
      CLK => clkSignal,
