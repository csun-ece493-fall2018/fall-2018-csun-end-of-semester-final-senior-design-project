...
--Date        : Tue Nov 27 21:41:12 2018
--Host        : Drew-GLT running 64-bit major release  (build 9200)
--Command     : generate_target Sensor_Project_wrapper.bd
...
entity Sensor_Project_wrapper is
  port (
...
end Sensor_Project_wrapper;

architecture STRUCTURE of Sensor_Project_wrapper is
  ...
  end component Sensor_Project;
begin
Sensor_Project_i: component Sensor_Project
     port map (
