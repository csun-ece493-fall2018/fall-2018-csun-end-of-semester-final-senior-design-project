...
set_property PACKAGE_PIN AA8  [get_ports {s00_pwm_right}];  # "JA10"
#set_property PACKAGE_PIN AA11 [get_ports {JA2}];  # "JA2"
#set_property PACKAGE_PIN Y10  [get_ports {JA3}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {s00_pwm_left}];  # "JA4"
...
set_property PACKAGE_PIN W8 [get_ports {s00_pwm_middle}];  # "JB4"
...
## JC Pmod - Bank 13
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB6 [get_ports {s00_axi_radar1_rx}];  # "JC1_N"
#set_property PACKAGE_PIN AB7 [get_ports {JC1_P}];  # "JC1_P"
set_property PACKAGE_PIN AA4 [get_ports {s00_axi_radar1_pwm }];  # "JC2_N"
#set_property PACKAGE_PIN Y4  [get_ports {JC2_P}];  # "JC2_P"
set_property PACKAGE_PIN T6  [get_ports {s00_axi_radar2_rx}];  # "JC3_N"
#set_property PACKAGE_PIN R6  [get_ports {JC3_P}];  # "JC3_P"
set_property PACKAGE_PIN U4  [get_ports {s00_axi_radar2_pwm}];  # "JC4_N"
...
#set_property PACKAGE_PIN R16 [get_ports {s}];  # "BTND"
#set_property PACKAGE_PIN N15 [get_ports {w}];  # "BTNL"
#set_property PACKAGE_PIN R18 [get_ports {e}];  # "BTNR"
