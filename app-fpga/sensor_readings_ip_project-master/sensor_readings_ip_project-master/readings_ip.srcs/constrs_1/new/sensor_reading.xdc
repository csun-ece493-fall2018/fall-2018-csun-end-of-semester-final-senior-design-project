...
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN Y11  [get_ports {'0'}];  # "JA1" #ANALOG
#set_property PACKAGE_PIN AA8  [get_ports {'0'}];  # "JA10" 
#set_property PACKAGE_PIN AA11 [get_ports {radar1_rx}];  # "JA2" #RX
#set_property PACKAGE_PIN Y10  [get_ports {'0'}];  # "JA3" #TX
#set_property PACKAGE_PIN AA9  [get_ports {radar1_pwm}];  # "JA4" #PW
#set_property PACKAGE_PIN AB11 [get_ports {'0'}];  # "JA7"
#set_property PACKAGE_PIN AB10 [get_ports {'0'}];  # "JA8"
#set_property PACKAGE_PIN AB9  [get_ports {'0'}];  # "JA9"

#set_property PACKAGE_PIN Y11  [get_ports {JA1}];  # "JA1"
#set_property PACKAGE_PIN AA8  [get_ports {SEV_SEG[4]}];  # "JA10"
...
#set_property PACKAGE_PIN AB11 [get_ports {SEV_SEG[7]}];  # "JA7"
#set_property PACKAGE_PIN AB10 [get_ports {SEV_SEG[6]}];  # "JA8"
#set_property PACKAGE_PIN AB9  [get_ports {SEV_SEG[5]}];  # "JA9"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN W12 [get_ports {'0'}];  # "JB1" #ANALOG
#set_property PACKAGE_PIN V8 [get_ports {'0'}];  # "JB10"
#set_property PACKAGE_PIN W11 [get_ports {radar2_rx}];  # "JB2" #RX
#set_property PACKAGE_PIN V10 [get_ports {'0'}];  # "JB3" #TX
#set_property PACKAGE_PIN W8 [get_ports {radar2_pwm}];  # "JB4" #PW
#set_property PACKAGE_PIN V12 [get_ports {'0'}];  # "JB7"
#set_property PACKAGE_PIN W10 [get_ports {'0'}];  # "JB8"
#set_property PACKAGE_PIN V9 [get_ports {'0'}];  # "JB9"

#set_property PACKAGE_PIN W12 [get_ports {JB1}];  # "JB1"
#set_property PACKAGE_PIN V8 [get_ports {SEV_SEG[0]}];  # "JB10"
...
#set_property PACKAGE_PIN V12 [get_ports {SEV_SEG[3]}];  # "JB7"
#set_property PACKAGE_PIN W10 [get_ports {SEV_SEG[2]}];  # "JB8"
#set_property PACKAGE_PIN V9 [get_ports {SEV_SEG[1]}];  # "JB9"
...
#set_property PACKAGE_PIN AB7 [get_ports {JC1_P}];  # "JC1_P" #ANALOG Sensor 1
set_property PACKAGE_PIN AA4 [get_ports {radar1_pwm}];  # "JC2_N" #PWM Sensor 1
#set_property PACKAGE_PIN Y4  [get_ports {JC2_P}];  # "JC2_P" #TX Sensor 1
set_property PACKAGE_PIN T6  [get_ports {radar2_rx}];  # "JC3_N" #RX Sensor 2
#set_property PACKAGE_PIN R6  [get_ports {JC3_P}];  # "JC3_P" #ANALOG Sensor 2
set_property PACKAGE_PIN U4  [get_ports {radar2_pwm}];  # "JC4_N" #PWM Sensor 2
#set_property PACKAGE_PIN T4  [get_ports {JC4_P}];  # "JC4_P" #TX Sensor 2

# ----------------------------------------------------------------------------
# JD Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN W7 [get_ports {tx_Y_output}];  # "JD1_N"
#set_property PACKAGE_PIN V7 [get_ports {tx_X_output}];  # "JD1_P"
...
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN F22 [get_ports {values[0]}];  # "SW0"
#set_property PACKAGE_PIN G22 [get_ports {values[1]}];  # "SW1"
#set_property PACKAGE_PIN H22 [get_ports {values[2]}];  # "SW2"
#set_property PACKAGE_PIN F21 [get_ports {values[3]}];  # "SW3"
#set_property PACKAGE_PIN H19 [get_ports {values[4]}];  # "SW4"
#set_property PACKAGE_PIN H18 [get_ports {values[5]}];  # "SW5"
#set_property PACKAGE_PIN H17 [get_ports {toggle}];  # "SW6"
#set_property PACKAGE_PIN M15 [get_ports {showXOrYOnSevSeg}];  # "SW7"
