...
HD_PWD='C:/Users/Naghmeh/Desktop/sensor_readings_ip_project-master/readings_ip.runs/sensor_reading_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sensor_reading_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sensor_reading_rst_ps7_0_100M_0.tcl
