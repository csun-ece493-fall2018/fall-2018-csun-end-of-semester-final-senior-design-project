...
HD_PWD='C:/Users/Naghmeh/Desktop/sensor_readings_ip_project-master/readings_ip.runs/sensor_reading_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sensor_reading_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sensor_reading_auto_pc_0.tcl
