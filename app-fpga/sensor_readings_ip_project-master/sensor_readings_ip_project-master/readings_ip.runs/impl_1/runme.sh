...
HD_PWD='C:/Users/Naghmeh/Desktop/sensor_readings_ip_project-master/readings_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sensor_reading_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sensor_reading_wrapper.tcl -notrace
