...
#
# Generated by export_simulation on Fri Nov 23 13:37:05 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './sensor_reading.sh' script.

./sensor_reading.sh -reset_run
...
./sensor_reading.sh -noclean_files

For more information on the script, please type './sensor_reading.sh -help'.
